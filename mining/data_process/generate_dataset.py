...
class generate_dataset:
    ...
    def genDataset(self,fileName):
        with open(fileName,"r+") as r_file:
            ...
            for codeData in codeFile:
                ...
                if isGenerated:
                    continue
                self.createAST("dataset/records/"+str(self.correctCodeCounter)+"/code.cpp","dataset/records/"+str(self.correctCodeCounter),self.correctCodeCounter)
    ...
    def createAST(self,readLoc,genLoc,folderNo):
