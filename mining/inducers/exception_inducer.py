        ...
        while noOfExc:
            ...
            for i in range(len(locSqrt)):
                ...
                tempSnip = tempSnip.replace(
                    code[startPos:endPos], 'sqrt({})'.format(random.randrange(-999999999, -1)))
        ...
        while noOfExc:
            ...
            for pos in arrLoc:
                ...
                tempCode = tempCode.replace(
                    code[startpos:endpos+1], f'{code[startpos:pos.end()]}{random.randint(10**9,10**11)}]')
                edit = 1
                tempFileExceptions -= 1
                noOfExc -= 1
                if not tempFileExceptions:
        ...
        while noOfExc:
            ...
            for pos in locCout:
                ...
                while self.codeSnip[endpos] not in "<;":
                    endpos += 1
                code = code.replace(self.codeSnip[pos.start(
                ):endpos], f'{self.codeSnip[pos.start():startpos]}{self.codeSnip[startpos:endpos].strip()}/0')
                edit = 1
                tempFileExceptions -= 1
                noOfExc -= 1
                if not tempFileExceptions:
        ...
        while noOfExc:
            ...
            for pos in locFunc:
                ...
                while self.codeSnip[endpos] != ')':
                    endpos += 1
                code = code.replace(
                    self.codeSnip[startpos:endpos], f'{self.codeSnip[startpos:sp]}{self.codeSnip[sp].swapcase()}{self.codeSnip[sp+1:endpos]}')
                edit = 1
                tempFileExceptions -= 1
                noOfExc -= 1
                if not tempFileExceptions:
